...
-- Thời gian đã tạo: Th6 02, 2026 lúc 09:31 AM
...
ALTER TABLE `alliances`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_alliance_event_orgs` (`event_id`,`org_a_id`,`org_b_id`),
...
ALTER TABLE `alliance_requests`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_alliance_request` (`event_id`,`requester_org_id`,`target_org_id`),
