...
--
-- Cơ sở dữ liệu: `mt_registration_portal`
--
...
CREATE TABLE `registrations` (
  ...
  `current_approval_index` int DEFAULT NULL COMMENT 'Index duyệt hiện tại',
  `next_approval_index` int DEFAULT NULL COMMENT 'Index duyệt tiếp theo',
  `is_sendmail` tinyint NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Cấu trúc bảng cho bảng `talent_rounds`
--
...
--
-- Cấu trúc bảng cho bảng `talent_round_results`
--

CREATE TABLE `talent_round_results` (
  `id` bigint UNSIGNED NOT NULL,
  `entry_id` bigint UNSIGNED NOT NULL,
  `round_id` bigint UNSIGNED NOT NULL,
  `score` decimal(8,2) DEFAULT NULL,
...
ALTER TABLE `talent_entries`
  ...
  ADD KEY `idx_talent_entries_round_id` (`round_id`);
...
--
-- Chỉ mục cho bảng `talent_rounds`
--
ALTER TABLE `talent_rounds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_talent_rounds_talent_show_id` (`talent_show_id`),
  ADD KEY `idx_talent_rounds_round_order` (`talent_show_id`,`round_order`);

--
-- Chỉ mục cho bảng `talent_round_results`
--
ALTER TABLE `talent_round_results`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_talent_round_results_entry_round` (`entry_id`,`round_id`),
  ADD KEY `idx_talent_round_results_round_id` (`round_id`);
...
ALTER TABLE `talent_scores`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_talent_scores_round_entry_judge_criteria` (`round_id`,`entry_id`,`judge_id`,`criteria`),
  ADD KEY `talent_scores_entry_id_foreign` (`entry_id`),
  ADD KEY `idx_talent_scores_round_id` (`round_id`);
...
--
-- AUTO_INCREMENT cho bảng `talent_rounds`
--
ALTER TABLE `talent_rounds`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `talent_round_results`
--
ALTER TABLE `talent_round_results`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `beauty_round_results`
  ADD CONSTRAINT `beauty_round_results_registration_id_foreign` FOREIGN KEY (`registration_id`) REFERENCES `beauty_contestants` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `talent_entries`
  ADD CONSTRAINT `fk_talent_entries_talent_rounds` FOREIGN KEY (`round_id`) REFERENCES `talent_rounds` (`id`),
...
--
-- Các ràng buộc cho bảng `talent_rounds`
--
ALTER TABLE `talent_rounds`
  ADD CONSTRAINT `fk_talent_rounds_talent_shows` FOREIGN KEY (`talent_show_id`) REFERENCES `talent_shows` (`id`);

--
-- Các ràng buộc cho bảng `talent_round_results`
--
ALTER TABLE `talent_round_results`
  ADD CONSTRAINT `fk_talent_round_results_talent_entries` FOREIGN KEY (`entry_id`) REFERENCES `talent_entries` (`id`),
  ADD CONSTRAINT `fk_talent_round_results_talent_rounds` FOREIGN KEY (`round_id`) REFERENCES `talent_rounds` (`id`);

--
-- Các ràng buộc cho bảng `talent_scores`
--
ALTER TABLE `talent_scores`
  ADD CONSTRAINT `fk_talent_scores_talent_rounds` FOREIGN KEY (`round_id`) REFERENCES `talent_rounds` (`id`),
