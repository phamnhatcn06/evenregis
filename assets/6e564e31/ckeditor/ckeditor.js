...
(function () {
    ...
    (function () {
        ...
        var f = function (a) {
            ...
            u: 1,
            "var": 1
        }, h = CKEDITOR.dom.walker.bogus(), j = new CKEDITOR.dom.walker.whitespaces, i = new CKEDITOR.dom.walker.bookmark, k = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                return function (a) {
                    ...
                    return {
                        start: g.container.getAddress(a), end: c ? null : d.container.getAddress(a),
    ...
    (function () {
        ...
        function f(a) {
            ...
            return a._.filterFunction = function (g, e, f, h, l, q, n) {
                ...
                if (e) {
                    var o = g.name, f = e.elements[o], u = e.generic, e = {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b,
                ...
                if (typeof a == "string") {
                    ...
                    d = {
                        name: g.element, attributes: n, classes: n["class"] ?
        ...
        var t = {styles: 1, attributes: 1, classes: 1}, C = {
            styles: "requiredStyles", attributes: "requiredAttributes",
            classes: "requiredClasses"
        }, y = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, n = {
            styles: /{([^}]+)}/,
            attrs: /\[([^\]]+)\]/,
            classes: /\(([^\)]+)\)/
    ...
    (function () {
        ...
        var F = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", s = CKEDITOR.dtd, x = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], z = CKEDITOR.tools.extend({}, s.$blockLimit, s.$block), t = {
            elements: {},
            ...
            return function (o, k, z) {
                ...
                if (!C.checkReadOnly()) {
                    var n = (new CKEDITOR.dom.elementPath(C.startContainer,
                        ...
                        mergeCandidates: [],
                        zombies: []
                    }, t = k.range, y = k.mergeCandidates, w, I, G, D;
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                if (a.length)if (this.isLocked) {
                    ...
                    if (q) {
                        var c = CKEDITOR.dom.walker.whitespaces(true), d = /\ufeff|\u00a0/, h = {
                            table: 1,
                            tbody: 1,
                            tr: 1
                        };
    ...
    (function () {
        ...
        var s = {
            ...
            audio: 1,
            video: 1
        }, z = /\s*(?:;\s*|$)/, t = /#\((.+?)\)/g, C = CKEDITOR.dom.walker.bookmark(0, 1), y = CKEDITOR.dom.walker.whitespaces(1);
