 ...
 * @since 1.1
 */
class MyCheckBoxColumn extends CGridColumn
{
	/**
...
EOD;
	...
	protected function renderHeaderCellContent()
	{
		if($this->selectableRows===null && $this->grid->selectableRows>1)
			echo CHtml::label($this->name,''). CHtml::checkBox($this->id.'_all',false,array('class'=>'select-on-check-all','name'=>$this->name.'_a'));
	...
	protected function renderDataCellContent($row,$data)
	{
		...
		echo CHtml::checkBox($name,$checked,$options).CHtml::hiddenField('all_'.$name,$value);
	}
}
