...
(function (j, C) {
        ...
        if (c.polar) {
            if (c.renderer.isSVG)if (d === !0 && (d = {}), b) {
                if (c = {
                        ...
                        scaleX: 0.001,
                        scaleY: 0.001
                    }, g.attr(c), f)f.attrSetters = g.attrSetters,
                    f.attr(c)
            } else c = {
                translateX: i,
                translateY: n,
    ...
    var G = N.prototype, u = u.prototype, T = {
        ...
        getPlotBandPath: function (a, b, c) {
            ...
            "circle" || !l ? (a = -Math.PI / 2, b = Math.PI * 1.5, n = !0) : (a = g + this.translate(a), b = g + this.translate(b)), d = this.chart.renderer.symbols.arc(this.left + d[0], this.top + d[1], e[0], e[0], {
                start: a,
                end: b,
    ...
    u = {
        type: "gauge", pointClass: j.extendClass(j.Point, {
            setState: function (a) {
                this.state = a
            }
            ...
            s(a.points, function (c) {
                ...
                b ? (b.animate(g), g.d = l) : c.graphic = f[c.shapeType](g).attr({
            ...
            c ? c.animate({
                translateX: b[0],
                translateY: b[1]
            }) : a.pivot = f.circle(0, 0, r(g.radius, 5)).attr({
    ...
    h.bubble = x(h.scatter, {
        ...
        translate: function () {
            ...
            for (a = b.length; a--;)c = b[a], d = g ? g[a] : 0, c.negative = c.z < (this.options.zThreshold || 0), d >= this.minPxSize / 2 ? (c.shapeType =
                "circle", c.shapeArgs = {x: c.plotX, y: c.plotY, r: d}, c.dlBox = {
                x: c.plotX - d,
                y: c.plotY - d,
                width: 2 * d,
                height: 2 * d
