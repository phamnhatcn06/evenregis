(function (e) {
    ...
    t.prototype = {
        constructor: t, initInput: function () {
            ...
            if (this.$form) {
                ...
                if (e) {
                    this.$loading.width(e)
                }
                if (t) {
                    this.$loading.height(t)
                }
                this.$form.hide()
            } else {
            ...
            if (e.type(r) === "object" && r.newValue !== undefined) {
                n = r.newValue;
                this.input.value2input(n);
            ...
            var i = this.input.value2submit(n);
            this.isSaving = true;
            e.when(this.save(i)).done(e.proxy(function (e) {
                this.isSaving = false;
                var t = typeof this.options.success === "function" ? this.options.success.call(this.options.scope, e, n) : null;
                if (t === false) {
                    this.error(false);
                    this.showForm(false);
                    return
                ...
                if (t && typeof t === "object" && t.hasOwnProperty("newValue")) {
                    n = t.newValue
                }
                this.error(false);
                this.value = n;
                this.$div.triggerHandler("save", {newValue: n, submitValue: i, response: e})
            }, this)).fail(e.proxy(function (e) {
                this.isSaving = false;
                var t;
                if (typeof this.options.error === "function") {
                    t = this.options.error.call(this.options.scope, e, n)
                } else {
                    t = typeof e === "string" ? e : e.responseText || e.statusText || "Unknown error!"
                }
                this.error(t);
                this.showForm()
            }, this))
        }, save: function (t) {
            this.options.pk = e.fn.editableutils.tryParseJson(this.options.pk, true);
            ...
            if (r) {
                ...
                if (typeof this.options.params === "function") {
                    ...
                    this.options.params = e.fn.editableutils.tryParseJson(this.options.params, true);
                    e.extend(i, this.options.params)
                }
                if (typeof this.options.url === "function") {
                    return this.options.url.call(this.options.scope, i)
                } else {
                    return e.ajax(e.extend({url: this.options.url, data: i, type: "POST"}, this.options.ajaxOptions))
                }
            }
        }, validate: function (e) {
            if (e === undefined) {
            ...
            if (t) {
                this.value = this.input.str2value(e)
            } else {
                this.value = e
            }
    ...
    e.fn.editableform = function (n) {
        ...
        return this.each(function () {
            ...
            if (!s) {
                i.data("editableform", s = new t(this, o))
            }
            if (typeof n === "string") {
...
(function (e) {
    ...
    e.fn.editableutils = {
        inherit: function (e, t) {
            ...
            if (s === "date") {
                if (t.mode === "inline") {
                    if (e.fn.editabletypes.datefield) {
                        s = "datefield"
                    } else if (e.fn.editabletypes.dateuifield) {
                        s = "dateuifield"
                    }
                } else {
                    if (e.fn.editabletypes.date) {
                        s = "date"
                    } else if (e.fn.editabletypes.dateui) {
                        s = "dateui"
                    }
                }
                if (s === "date" && !e.fn.editabletypes.date) {
                    s = "combodate"
                }
            }
            if (s === "datetime" && t.mode === "inline") {
                s = "datetimefield"
            }
            if (s === "wysihtml5" && !e.fn.editabletypes[s]) {
                s = "textarea"
            }
    ...
    t.prototype = {
        ...
        init: function (n, r) {
            ...
            if (!e(document).data("editable-handlers-attached")) {
                e(document).on("keyup.editable", function (t) {
                    if (t.which === 27) {
                        e(".editable-open").editableContainer("hide")
                    }
                });
                ...
                e(document).data("editable-handlers-attached", true)
            }
        },
        splitOptions: function () {
            ...
            for (var t in this.options) {
                if (t in this.defaults) {
                    this.containerOptions[t] = this.options[t]
                } else {
                    this.formOptions[t] = this.options[t]
                }
            }
        },
        tip: function () {
        ...
        option: function (e, t) {
            ...
            if (e in this.containerOptions) {
                ...
                if (this.$form) {
                    this.$form.editableform("option", e, t)
                }
            }
        },
        ...
        closeOthers: function (t) {
            e(".editable-open").each(function (n, r) {
                ...
                if (s.options.onblur === "cancel") {
                    i.data("editableContainer").hide("onblur")
                } else if (s.options.onblur === "submit") {
...
(function (e) {
    ...
    var t = function (t, n) {
        ...
        if (this.options.highlight && !e.fn.editableutils.supportsTransitions()) {
    ...
    t.prototype = {
        constructor: t, init: function () {
            ...
            if (this.options.value === undefined || this.options.value === null) {
                ...
                this.options.value = e.fn.editableutils.tryParseJson(this.options.value, true);
            ...
            e.when(n ? this.render() : true).then(e.proxy(function () {
                if (this.options.disabled) {
                    this.disable()
                } else {
                    this.enable()
            ...
            this.$element.on(this.options.toggle + ".editable", t, e.proxy(function (t) {
                var n = e(t.target);
                if (!n.data("editable")) {
                    if (n.hasClass(this.options.emptyclass)) {
                        n.empty()
                    }
            ...
            if (this.input.value2htmlFinal) {
                return this.input.value2html(this.value, this.$element[0], this.options.display, e)
            } else if (typeof this.options.display === "function") {
                return this.options.display.call(this.$element[0], this.value, e)
            } else {
            ...
            if (this.container) {
                this.container.option(t, n)
            }
            if (this.input.option) {
                this.input.option(t, n)
            }
            ...
            if (t !== undefined) {
                ...
                if (typeof this.input.isEmpty === "function") {
                    ...
                    this.isEmpty = e.trim(this.$element.html()) === ""
                }
            }
            if (!this.options.disabled) {
                if (this.isEmpty) {
            ...
            if (this.options.unsavedclass) {
                ...
                n = n || this.options.display === false;
            ...
            this.setValue(t.newValue, false, t.response)
        }, validate: function () {
            if (typeof this.options.validate === "function") {
            ...
            if (n) {
                this.value = this.input.str2value(t)
            } else {
                this.value = t
            }
            if (this.container) {
    ...
    e.fn.editable = function (n) {
        ...
        switch (n) {
            ...
            case"getValue":
                ...
                return r;
            case"submit":
                var o = arguments[1] || {}, u = this, a = this.editable("validate");
                if (e.isEmptyObject(a)) {
                    var f = {};
                    if (u.length === 1) {
                        var l = u.data("editable");
                        var c = {
                            name: l.options.name || "",
                            value: l.input.value2submit(l.value),
                            pk: typeof l.options.pk === "function" ? l.options.pk.call(l.options.scope) : l.options.pk
                        };
                        if (typeof l.options.params === "function") {
                            c = l.options.params.call(l.options.scope, c)
                        } else {
                            l.options.params = e.fn.editableutils.tryParseJson(l.options.params, true);
                            e.extend(c, l.options.params)
                        }
                        f = {url: l.options.url, data: c, type: "POST"};
                        o.success = o.success || l.options.success;
                        o.error = o.error || l.options.error
                    } else {
                        var h = this.editable("getValue");
                        f = {url: o.url, data: h, type: "POST"}
                    }
                    f.success = typeof o.success === "function" ? function (e) {
                        o.success.call(u, e, o)
                    } : e.noop;
                    f.error = typeof o.error === "function" ? function () {
...
(function (e) {
    ...
    t.prototype = {
        init: function (t, n, r) {
            ...
            if (this.options[e] !== undefined && this.options[e] !== null) {
    ...
    t.defaults = {tpl: "", inputclass: null, escape: true, scope: null, showbuttons: true};
...
(function (e) {
    ...
    e.extend(t.prototype, {
        render: function () {
            ...
            try {
                r = e.fn.editableutils.tryParseJson(r, false)
            } catch (i) {
                n.call(this);
                return
            }
            if (typeof r === "string") {
                if (this.options.sourceCache) {
                    var s = r, o;
                    if (!e(document).data(s)) {
                        e(document).data(s, {})
                    }
                    o = e(document).data(s);
                    if (o.loading === false && o.sourceData) {
                        this.sourceData = o.sourceData;
                        this.doPrepend();
                        t.call(this);
                        return
                    } else if (o.loading === true) {
                ...
                var u = e.extend({
                    url: r, type: "get", cache: false, dataType: "json", success: e.proxy(function (r) {
                        if (o) {
                            o.loading = false
                        }
            ...
            if (!e.isArray(this.prependData)) {
                if (e.isFunction(this.options.prepend)) {
                    this.options.prepend = this.options.prepend.call(this.options.scope)
                }
                this.options.prepend = e.fn.editableutils.tryParseJson(this.options.prepend, true);
                if (typeof this.options.prepend === "string") {
                    this.options.prepend = {"": this.options.prepend}
                }
                this.prependData = this.makeArray(this.options.prepend)
            }
            if (e.isArray(this.prependData) && e.isArray(this.sourceData)) {
...
(function (e) {
    ...
    t.defaults = e.extend({}, e.fn.editabletypes.list.defaults, {tpl: "<select></select>"});
...
(function (e) {
    ...
    t.defaults = e.extend({}, e.fn.editabletypes.text.defaults, {tpl: '<input type="password">'});
...
(function (e) {
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.text);
    t.defaults = e.extend({}, e.fn.editabletypes.text.defaults, {tpl: '<input type="email">'});
...
(function (e) {
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.text);
    t.defaults = e.extend({}, e.fn.editabletypes.text.defaults, {tpl: '<input type="url">'});
...
(function (e) {
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.text);
    t.defaults = e.extend({}, e.fn.editabletypes.text.defaults, {tpl: '<input type="tel">'});
...
(function (e) {
    ...
    t.defaults = e.extend({}, e.fn.editabletypes.abstractinput.defaults, {tpl: '<input type="time">'});
...
(function (e) {
    ...
    var t = function (n) {
        ...
        this.sourceData = null;
        if (n.placeholder) {
            n.select2.placeholder = n.placeholder
        }
        if (!n.select2.tags && n.source) {
            var r = n.source;
            if (e.isFunction(n.source)) {
                r = n.source.call(n.scope)
            }
            if (typeof r === "string") {
                n.select2.ajax = n.select2.ajax || {};
                if (!n.select2.ajax.data) {
                    n.select2.ajax.data = function (e) {
                        return {query: e}
                    }
                }
                if (!n.select2.ajax.results) {
    ...
    e.extend(t.prototype, {
        render: function () {
            this.setClass();
            if (this.isRemote) {
                this.$input.on("select2-loaded", e.proxy(function (e) {
            ...
            if (this.options.select2.tags) {
                ...
                s = e.fn.editableutils.itemsByValue(n, this.sourceData, this.idFunc)
            } else {
            }
            if (e.isArray(s)) {
                i = [];
            ...
            if (e.isArray(t)) {
                t = t.join(this.getSeparator())
            }
            if (!this.$input.data("select2")) {
                this.$input.val(t);
                this.$input.select2(this.options.select2)
            } else {
                this.$input.val(t).trigger("change", true)
            }
            if (this.isRemote && !this.isMultiple && !this.options.select2.initSelection) {
                var n = this.options.select2.id, r = this.options.select2.formatSelection;
                if (!n && !r) {
                    var i = e(this.options.scope);
                    if (!i.data("editable").isEmpty) {
                        var s = {id: t, text: i.text()};
...
(function (e) {
    ...
    t.prototype = {
        constructor: t, init: function () {
            ...
            this.initCombos();
            this.$widget.on("change", "select", e.proxy(function (t) {
                this.$element.val(this.getValue()).change();
                if (this.options.smartDays) {
                    if (e(t.target).is(".month") || e(t.target).is(".year")) {
                        this.fillCombo("day")
                    }
                }
            }, this));
            ...
            var n = "fill" + e.charAt(0).toUpperCase() + e.slice(1);
            var r = this[n]();
            var i = t.val();
            t.empty();
            for (var s = 0; s < r.length; s++) {
                t.append('<option value="' + r[s][0] + '">' + r[s][1] + "</option>")
            }
            t.val(i)
            ...
            if (this.options.firstItem === "name") {
                ...
                var r = typeof n[e] === "function" ? n[e](1, true, e, false) : n[e];
                r = r.split(" ").reverse()[0];
                t.push(["", r])
            ...
            var e = this.fillCommon("d"), t, n, r = this.options.template.indexOf("DD") !== -1, i = 31;
            if (this.options.smartDays && this.$month && this.$year) {
                var s = parseInt(this.$month.val(), 10);
                var o = parseInt(this.$year.val(), 10);
                if (!isNaN(s) && !isNaN(o)) {
                    i = moment([o, s]).daysInMonth()
                }
            }
            for (n = 1; n <= i; n++) {
            ...
            var e = this.fillCommon("M"), t, n, r = this.options.template.indexOf("MMMM") !== -1, i = this.options.template.indexOf("MMM") !== -1, s = this.options.template.indexOf("MM") !== -1;
            for (n = 0; n <= 11; n++) {
                if (r) {
            ...
            e = this.fillCommon("y").concat(e);
            return e
        }, fillHour: function () {
            var e = this.fillCommon("h"), t, n, r = this.options.template.indexOf("h") !== -1, i = this.options.template.indexOf("H") !== -1, s = this.options.template.toLowerCase().indexOf("hh") !== -1, o = r ? 1 : 0, u = r ? 12 : 23;
            for (n = o; n <= u; n++) {
            ...
            var e = this.fillCommon("m"), t, n, r = this.options.template.indexOf("mm") !== -1;
            ...
            var e = this.fillCommon("s"), t, n, r = this.options.template.indexOf("ss") !== -1;
            ...
            if (this.$ampm) {
                if (r.hour === 12) {
                    ...
                    r.hour = this.$ampm.val() === "am" ? r.hour : r.hour + 12
                }
            }
            ...
            if (n.isValid()) {
                ...
                e.each(i, function (e, t) {
                    if (r["$" + e]) {
                        if (e === "minute" && r.options.minuteStep > 1 && r.options.roundTime) {
                            t = s(r["$" + e], t)
                        }
                        if (e === "second" && r.options.secondStep > 1 && r.options.roundTime) {
                            t = s(r["$" + e], t)
                        }
                        r["$" + e].val(t)
                    }
    ...
    e.fn.combodate = function (n) {
        ...
        i.shift();
        if (n === "getValue" && this.length && (r = this.eq(0).data("combodate"))) {
            return r.getValue.apply(r, i)
        }
        return this.each(function () {
            var r = e(this), s = r.data("combodate"), o = typeof n == "object" && n;
            if (!s) {
                r.data("combodate", s = new t(this, o))
            }
            if (typeof n == "string" && typeof s[n] == "function") {
                s[n].apply(s, i)
            }
        })
    };
...
(function (e) {
    ...
    var t = function (n) {
        ...
        n.combodate = e.fn.editableutils.tryParseJson(n.combodate, true);
...
(function (e) {
    ...
    e.extend(e.fn.editableform.Constructor.prototype, {
        initTemplate: function () {
            ...
            t.apply(this);
            var n = this.input.options.inputclass === null || this.input.options.inputclass === false;
            var r = "input-sm";
            var i = "text,select,textarea,password,email,url,tel,number,range,time,typeaheadjs".split(",");
            ...
            var s = this.$form.find(".editable-buttons");
            var o = n ? [r] : this.input.options.inputclass.split(" ");
            for (var u = 0; u < o.length; u++) {
                if (o[u].toLowerCase() === "input-lg") {
                    s.find("button").removeClass("btn-sm").addClass("btn-lg")
                }
            }
        }
    });
    e.fn.editableform.buttons = '<button type="submit" class="btn btn-primary btn-sm editable-submit">' + '<i class="glyphicon glyphicon-ok"></i>' + "</button>" + '<button type="button" class="btn btn-default btn-sm editable-cancel">' + '<i class="glyphicon glyphicon-remove"></i>' + "</button>";
...
(function (e) {
    ...
    e.extend(e.fn.editableContainer.Popup.prototype, {
        ...
        setPosition: function () {
            (function () {
                var e = this.tip();
                var t = typeof this.options.placement == "function" ? this.options.placement.call(this, e[0], this.$element[0]) : this.options.placement;
                var n = /\s?auto?\s?/i;
                var r = n.test(t);
                if (r) {
                    t = t.replace(n, "") || "top"
                ...
                var s = e[0].offsetWidth;
                var o = e[0].offsetHeight;
                if (r) {
                    var u = this.$element.parent();
                    var a = t;
                    var f = document.documentElement.scrollTop || document.body.scrollTop;
                    var l = this.options.container == "body" ? window.innerWidth : u.outerWidth();
                    var c = this.options.container == "body" ? window.innerHeight : u.outerHeight();
                    var h = this.options.container == "body" ? 0 : u.offset().left;
                    t = t == "bottom" && i.top + i.height + o - f > c ? "top" : t == "top" && i.top - f - o < 0 ? "bottom" : t == "right" && i.right + s > l ? "left" : t == "left" && i.left - s < h ? "right" : t;
                    e.removeClass(a).addClass(t)
                }
                var p = this.getCalculatedOffset(t, i, s, o);
                this.applyPlacement(p, t)
            }).call(this.container())
        }
    })
})(window.jQuery);
(function (e) {
    ...
    if (!e.fn.datepicker) {
        e.fn.datepicker = e.fn.bdatepicker
    }
    var t = function (e) {
    ...
    e.extend(t.prototype, {
        initPicker: function (t, n) {
            ...
            t.datepicker = e.fn.editableutils.tryParseJson(t.datepicker, true);
            this.options.datepicker = e.extend({}, n.datepicker, t.datepicker, {format: this.options.viewformat});
...
(function (e) {
    ...
    e.extend(t.prototype, {
        initPicker: function (t, n) {
            ...
            t.datetimepicker = e.fn.editableutils.tryParseJson(t.datetimepicker, true);
            this.options.datetimepicker = e.extend({}, n.datetimepicker, t.datetimepicker, {format: this.options.viewformat});
            ...
            if (e) {
                this.$input.data("datetimepicker").setDate(e)
            }
        }, input2value: function () {
