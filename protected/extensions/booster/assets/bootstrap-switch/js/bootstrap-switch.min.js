...
(function () {
    ...
    !function (e, s) {
        ...
        return o = function () {
            ...
            return t.prototype.name = "bootstrap-switch", t.prototype._constructor = t, t.prototype.state = function (t, e) {
                ...
                return this.$label.on({
                    "mousemove.bootstrapSwitch touchmove.bootstrapSwitch": function (t) {
                        return function (e) {
                            var s, o, n;
                            if (t.drag)return e.preventDefault(), o = ((e.pageX || e.originalEvent.touches[0].pageX) - t.$wrapper.offset().left) / t.$wrapper.width() * 100, s = 25, n = 75, s > o ? o = s : o > n && (o = n), t.$container.css("margin-left", "" + (o - n) + "%"), t.$element.trigger("focus.bootstrapSwitch")
                        }
