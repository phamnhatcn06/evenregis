        ...
        <p>
            <xsl:call-template name="label">
                ...
                <xsl:with-param name="tooltip"
                                select="'Do not use it in any new code and try to remove usage of it in existing code.'"/>
            </xsl:call-template>
    ...
    <xsl:template match="p[@label=internal]">
        <p>
            <xsl:call-template name="label">
                ...
                <xsl:with-param name="tooltip"
                                select="'You are not expected to change this property in normal usage.'"/>
            </xsl:call-template>
