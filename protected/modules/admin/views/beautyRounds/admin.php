...
$this->Tabletitle = 'Quản lý vòng thi Miss';

Yii::app()->clientScript->registerScriptFile(
    Yii::app()->theme->baseUrl . '/assets/js/pages/beauty-rounds-admin.js',
    ...
    <div class="card-body">
        <form method="get" action="<?php echo $this->createUrl('admin'); ?>" class="row g-3 align-items-end">
            <div class="col-md-4">
                ...
                <select name="BeautyRounds[contest_id]" class="form-select">
                    <option value="">-- Tất cả --</option>
                    <?php foreach ($contests as $id => $name): ?>
                    <option value="<?php echo $id; ?>" <?php echo ($model->contest_id == $id) ? 'selected' : ''; ?>>
            ...
            <div class="col-md-3">
                ...
                <select name="BeautyRounds[round_type]" class="form-select">
                    <option value="">-- Tất cả --</option>
                    <?php foreach (BeautyRounds::getRoundTypeOptions() as $type => $label): ?>
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="BeautyRounds[name]" class="form-control" value="<?php echo CHtml::encode($model->name); ?>" placeholder="Tìm theo tên...">
            </div>
            <div class="col-md-2">
            ...
            <table class="table table-striped table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo CHtml::encode(isset($data->contest_name) ? $data->contest_name : ''); ?></td>
                        <td><span class="badge bg-info"><?php echo BeautyRounds::getRoundTypeLabel($data->round_type); ?></span></td>
                        ...
                        <td>
                            <?php echo IconHelper::actionButtons($data, array('view', 'update', 'delete'), '/admin/beautyRounds'); ?>
                        </td>
                    </tr>
