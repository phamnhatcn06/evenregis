...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textFieldGroup($model, 'prefix', array('maxlength' => 20, 'widgetOptions' => array('htmlOptions' => array(
      'class' => 'input w-full border mt-2'
    )))); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textFieldGroup($model, 'code', array('maxlength' => 20, 'widgetOptions' => array('htmlOptions' => array(
      'class' => 'input w-full border mt-2'
    )))); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'smile_code'); ?>
		<?php echo $form->textFieldGroup($model, 'smile_code', array('maxlength' => 20, 'widgetOptions' => array('htmlOptions' => array(
      'class' => 'input w-full border mt-2'
    )))); ?>
	</div>
