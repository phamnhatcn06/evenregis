...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textFieldGroup($model, 'division_code', array('maxlength' => 50, 'widgetOptions' => array('htmlOptions' => array(
      'class' => 'input w-full border mt-2'
    )))); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textFieldGroup($model, 'department_code', array('maxlength' => 50, 'widgetOptions' => array('htmlOptions' => array(
      'class' => 'input w-full border mt-2'
    )))); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textFieldGroup($model, 'level', array(
	...
	<div class="row">
		...
		<?php echo $form->textFieldGroup($model, 'code', array('maxlength' => 255, 'widgetOptions' => array('htmlOptions' => array(
      'class' => 'input w-full border mt-2'
    )))); ?>
	</div>
