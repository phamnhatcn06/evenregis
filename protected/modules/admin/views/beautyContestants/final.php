<?php
/* @var $this BeautyContestantsController */
/* @var $contests array id=>name */

$this->breadcrumbs = array(
    'Thi Miss' => array('admin'),
    'Chọn vào chung kết',
);
...
<div class="card mb-3">
    <div class="card-body">
        <div class="row g-3 align-items-end">
            <div class="col-md-6">
                <label class="form-label">Cuộc thi sắc đẹp <span class="text-danger">*</span></label>
...
<div id="finals-app"
     data-mode="single"
     data-candidates-url="<?php echo $this->createUrl('/admin/beautyContestants/finalCandidates'); ?>"
     data-list-url="<?php echo $this->createUrl('/admin/beautyContestants/finalList'); ?>"
     data-add-url="<?php echo $this->createUrl('/admin/beautyContestants/finalAdd'); ?>"
     data-remove-url="<?php echo $this->createUrl('/admin/beautyContestants/finalRemove'); ?>">
    <div class="row g-3">
        <div class="col-lg-6">
