...
MyHelper::renderDeleteButton($this, 'talentRounds', $model->id);
...
<div class="card">
    <div class="card-body">
        ...
        $attributes = array(
            ...
            array('label' => $model->getAttributeLabel('talent_show_id'), 'value' => $model->talent_show_name),
            array('label' => $model->getAttributeLabel('name'), 'value' => $model->name),
            array(
                'label' => $model->getAttributeLabel('round_type'),
                'value' => TalentRounds::getRoundTypeLabel($model->round_type)
            ),
