...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'parent_id', GxHtml::listDataEx(Sports::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'type'); ?>
		<?php echo $form->textFieldGroup($model, 'type', array('maxlength' => 10, 'widgetOptions' => array('htmlOptions' => array(
      'class' => 'input w-full border mt-2'
    )))); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textFieldGroup($model, 'document', array('maxlength' => 500, 'widgetOptions' => array('htmlOptions' => array(
      'class' => 'input w-full border mt-2'
    )))); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->switchGroup($model, 'is_active',
				array(
					'widgetOptions' => array(
						'events'=>array(
