                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control datepicker" name="check_out_date" id="staff_departure_date" required placeholder="dd/mm/yyyy" autocomplete="off">
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control datepicker" name="check_in_date" id="edit_arrival_date" placeholder="dd/mm/yyyy" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Ngày đi</label>
                                        <input type="text" class="form-control datepicker" name="check_out_date" id="edit_departure_date" placeholder="dd/mm/yyyy" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Ngày đến <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control datepicker" name="check_in_date" id="add_arrival_date" required placeholder="dd/mm/yyyy" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Ngày đi <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control datepicker" name="check_out_date" id="add_departure_date" required placeholder="dd/mm/yyyy" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
