...
class TransportsController extends AdminController
{
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['Transports'])) {
			$model->setAttributes($_POST['Transports']);
	...
	public function actionDelete($id)
	{
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$result = Transports::deleteViaApi($id);
	...
	{
		$model = new Transports('search');
		$model->unsetAttributes();

		if (isset($_GET['Transports'])) {
			$model->setAttributes($_GET['Transports']);
		}
		...
		$dataProvider = Transports::getApiDataProvider($params);
	...
	{
		$model = Transports::fetchFromApi($id);
		if ($model === null) {
