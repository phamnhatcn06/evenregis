...
class ReportsController extends AdminController
{
    ...
    /**
     * Báo cáo thống kê người đăng ký theo cụm và đơn vị
     * Phân tích theo NGƯỜI chứ không phải theo MÔN
     */
    public function actionAttendeeStats()
    {
        $user = AuthHandler::getUser();
        if (!$user) {
            throw new CHttpException(403, 'Bạn cần đăng nhập để xem báo cáo.');
        ...
        // Build báo cáo
        $reportData = $this->buildAttendeeStatsReport($selectedEventId, $isHO, $userPropertyId);
        ...
        Yii::app()->clientScript->registerScriptFile(
            Yii::app()->theme->baseUrl . '/assets/js/pages/reports-attendee-stats.js',
            CClientScript::POS_END
        );

        $this->render('attendeeStats', array(
            'isHO' => $isHO,
            'eventsList' => $eventsList,
            'selectedEventId' => $selectedEventId,
            'selectedEventName' => $selectedEventName,
     ...
     */
    protected function buildAttendeeStatsReport($eventId, $isHO, $userPropertyId)
    {
        if (!$eventId) {
            return array(
                'regionals' => array(),
