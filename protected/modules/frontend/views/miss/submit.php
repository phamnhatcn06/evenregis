            ...
            <form id="miss-submit-form" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="photo-upload-wrapper <?php echo !empty($model->photo_portrait_2) ? 'has-image' : ''; ?>" id="wrapper-portrait2">
                            ...
                            <img class="photo-preview" id="preview-portrait2" alt="Preview"
                                ...
                                src="<?php echo Yii::app()->baseUrl . '/' . $model->photo_portrait_2; ?>"
                                style="display: block;"
                                <?php endif; ?>>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="photo-upload-wrapper <?php echo !empty($model->photo_full_body) ? 'has-image' : ''; ?>" id="wrapper-fullbody">
                            ...
                            <img class="photo-preview" id="preview-fullbody" alt="Preview"
                                ...
                                src="<?php echo Yii::app()->baseUrl . '/' . $model->photo_full_body; ?>"
                                style="display: block;"
                                <?php endif; ?>>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="photo-upload-wrapper <?php echo !empty($model->photo_full_body_2) ? 'has-image' : ''; ?>" id="wrapper-fullbody2">
                            ...
                            <img class="photo-preview" id="preview-fullbody2" alt="Preview"
                                ...
                                src="<?php echo Yii::app()->baseUrl . '/' . $model->photo_full_body_2; ?>"
                                style="display: block;"
                                <?php endif; ?>>
                        </div>
                    </div>
