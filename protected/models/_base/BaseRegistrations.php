...
abstract class BaseRegistrations extends GxActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'period_id' => null,
			'submitted_by' => Yii::t('app', 'Người nộp'),
			'status' => Yii::t('app', 'Trạng thái'),
			'document' => Yii::t('app', 'Tài liệu'),
			'submitted_at' => Yii::t('app', 'Thời gian nộp'),
			'reviewed_by' => Yii::t('app', 'Người duyệt'),
			'reviewed_at' => Yii::t('app', 'Thời gian duyệt'),
			'rejection_reason' => Yii::t('app', 'Lý do từ chối'),
