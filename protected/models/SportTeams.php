...
class SportTeams extends BaseSportTeams
{
    ...
    {
        $rules = parent::rules();
        $rules[] = array('event_name, sport_name, property_name, property_code, registration_name, alliance_org_names, alliance_org_ids, member_count, team_name, is_alliance, alliance_property_ids, status, registration_id', 'safe');
        return $rules;
    }
