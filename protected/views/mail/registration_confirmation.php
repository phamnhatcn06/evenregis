    ...
    <td style="padding:30px 25px;">
        ...
        <div style="background-color:#fef9c3; border:1px solid #fde047; border-radius:6px; padding:15px 20px; margin-top:20px; font-size:14px; line-height:1.7;">
            ...
            <div style="color:#dc2626; font-weight:bold;">
                - Các trường hợp đã gửi hồ sơ thay đổi người tham dự đã được xử lý và cập nhật. Đơn vị vui lòng kiểm tra nội dung email và file pdf đính kèm, nếu có vấn đề cần báo lại BTC.
            </div>
