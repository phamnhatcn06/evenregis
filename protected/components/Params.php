...
class Params
{
    public static $sign ='DSH';
    public static $company_name = 'Công ty Cổ phần Đầu tư Hạ tầng Đông Sơn';

    public static $mostImportant = 3;
    public static $office_zone = 12;
    public static $category_type = array(
       1=>'Bầu cử Hội đồng quản trị',
       2=>'Bầu cử ban kiểm soát',
    );
    public static $share_holder_cate = array(
        1 => 'Tổ chức',
        2 => 'Cá nhân',
    );
    public static $share_holder_type = array(
        1 => 'Cổ đông (Uỷ quyền cho người khác cổ phần)',
        2 => 'Người nhận uỷ quyền (Nhận uỷ quyền từ cổ đông khác)',
    );
    ...
    public static $answer_list = array(
        1 => 'Tán thành',
        2 => 'Không tán thành',
        3 => 'Không có ý kiến',
        4 => 'Không hợp lệ',
    );
    public static $checklistType = 1;
    public static $checkRoomType = 2;
    public static $modChecklist = 17;
    public static $modGuestlist = 18;
    public static $Important = 7;
    public static $OtherPrio = 10;
    public static $viewed_status = 1;
    public static $active = 1;
    public static $softwareId = 9;
    public static $noneactive = 0;
    public static $deleted = 2;
    public static $guestRole = 12;
    public static $NTDRole = 13;
    public static $rootRole = 5;
    public static $gmRole = 13;
    public static $dgmRole = 16;
    public static $ksRole = 14;
    public static $adminRole = 1;
    public static $not_viewed_status = 0;
    public static $ok_status = 1;
    public static $not_ok_status = 2;
    public static $na_status = 3;

    const ENABLE_HTTPS_MODULE_PATH = 'admin,api,apis,mongo';    //exp: abongda.vn/admin
    //Slide show obj type
    public static $specialRoleArr = array(1, 5);
    public static $highestRole = array(5);
    public static $approved_status = 1;
    public static $approved_err_status = array(
        1 => 'GM đang duyệt',
        2 => 'GM đã duyệt',
        3 => 'VPDH chưa duyệt',
        4 => 'VPDH đã duyệt',
        5 => 'Chưa xong',
        6 => 'Đợi chuyên gia duyệt',
        7 => 'Yêu cầu tạm dừng',
        8 => 'Yêu cầu duyệt phương án',
        9 => 'Đã duyệt phương án',
        10 => 'Chưa duyệt phương án'
    );
    public static $departUnit = array(
        1 => 'Văn phòng điều hành',
        2 => 'Đơn vị thành viên',
    );

    public static $GM_not_approve = 1;
    public static $GM_approve = 2;
    public static $head_not_approve = 3;
    public static $head_approve = 4;
    public static $not_done = 5;
    public static $wait_expert = 6;
    public static $stop_request = 7;
    public static $approve_solution_request = 8;
    public static $approved_solution_request = 9;
    public static $no_approved_solution_request = 10;
    public static $no_approved_status = 0;
    public static $is_hot = 1;
    public static $not_hot = 0;
    public static $limitCV = 10;
    public static $listText = array(
        'all',
        'not-done',
        'gm-not-approve',
        'gm-approve',
    ...
    public static $statusFix = array(
        ...
        4 => 'Hoàn thành',
        5 => 'Quá hạn',
        7 => 'Yêu cầu dừng lại',
        8 => 'Yêu cầu VPDH sửa',
    );
    public static $fixStatus = array(
        'chua-sua' => 0,
        'da-sua' => 1,
        'tam-dung' => 2,
        'sua-lai' => 3,
    ...
    public static $gm_approve_mkt = array(
        0 => 'Chưa gửi GM',
        1 => 'Đã gửi GM',
        2 => 'GM đã duyệt',
        3 => 'GM yêu cầu làm lại'
    );
    ...
    public static $unitFix = array(
        'vpdh' => 'Văn phòng điều hành',
        'donvi' => 'Đơn vị'
    );
    public static $hotelunitFix = array(
        'donvi' => 'Đơn vị'
    );
    public static $expertRole = 15;
    public static $usernameRootMail = 'ksclweb@muongthanh.vn';
    public static $passwordRootMail = '123456a@A';
    public static $mainLink = 'https://kscl.muongthanh.vn';
    public static $tuyendungadminMail = 'phamnhat.cn06@gmail.com';
    public static $eng = array(1 => "Rất tốt", 2 => 'Tốt', 3 => 'Trung Bình', 4 => 'Kém');
    public static $masterPass = 'pvn@!@#$%^';
    ...
    //  Request Status
    public static $request_notApprove = 0;
    public static $request_gmApprove = 1;
    public static $request_vpdhApprove = 2;
    public static $request_vpdhNotApprove = 3;
    public static $request_requestProcessing = 4;
    public static $request_requestDone = 5;
    public static $error_kscl = 1;
    public static $error_mod = 2;
    //End Request Status
    public static $fontAwesomeArr = array(
        'fa-glass' => '&#xf000',
        'fa-music' => '&#xf001',
        'fa-search' => '&#xf002',
        'fa-envelope-o' => '&#xf003',
    ...
    public static $messageLogEditErr = 'Người dùng {user} đã thay đổi thông tin.';
}